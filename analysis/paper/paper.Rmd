...
author:
  - name: Eikichi Ono
    ...
    email: e0491209@u.nus.edu
    affiliation: National Universty of Singapore
    affiliation_url: https://Institute/Website
    orcid_id: 0000-0000-0000-0000
    footnote: 1
address:
  - code: National Universty of Singapore
...
```{r table}
knitr::kable(head(mtcars), caption = "A result table",
